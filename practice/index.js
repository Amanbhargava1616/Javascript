...
let parso = JSON.parse(
	'{"f_name":"Aman","l_name":"Bhargava","age":34,"sec":"A"}'
);
console.log(parso);
...
para.addEventListener("click", myfunction2());

// var lethello = function () {
// 	para.innerHTML = "Aman is here";
// };
// setInterval(lethello, 1000);

let confo = confirm("Shall we procced?");
